...
HD_PWD='D:/vivado1/Exper2019/signal_V_Test/sorting/sorting.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log IP2SOC_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source IP2SOC_Top.tcl
