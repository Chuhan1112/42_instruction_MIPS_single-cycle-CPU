...
HD_PWD='D:/vivado1/Exper2019/signal_V_Test/sorting/sorting.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log IP2SOC_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source IP2SOC_Top.tcl -notrace
